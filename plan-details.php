                ...
                <form action="create_plan_script.php" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <label>From</label>
                            <div class="form-group">
                                <input type="date" class="form-control" min="2020-04-01" max="2020-12-20" required name="from_date" placeholder="dd/mm/yyyy">
                            </div>
                        </div>
                        <div class="col-sm-6">
                        <label>To</label>
                            <div class="form-group">
                                <input type="date" class="form-control" min="2020-04-01" max="2020-12-20" required name="to_date" placeholder="dd/mm/yyyy">
                            </div>                       
                        </div>
                    </div>
                    <?php
