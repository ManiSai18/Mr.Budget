...
<head>
  ...
  <title>Plans Expenses</title>
  <link rel="stylesheet" href="css/plans_expense.css">
  
</head>
<body>
    <?php include 'includes/header.php';?>
    <form action="plan.php">
      <button type="submit" class="btn btn-outline-primary b1" style="border-color:darkcyan;"><b><span  class="glyphicon glyphicon-chevron-left"></span>Go back</b></button>
    </form>
    <?php
    $plan_id = $pid;
    ...
    if(mysqli_num_rows($result)>=1){?>
                ...
                <div class="panel panel-primary pn1" style="border-color:darkcyan;">
                    <div class="panel-heading" style="background-color:darkcyan; ">
                            <p class="text-center"><?php echo $row["expense_title"]; ?> </p>
                    </div>
                    <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <?php }
                                    ...
                                    $val = $row['expense_id'];  ?>
                                        ...
                                        <p class="text-center p"><button type="submit" name="bill" formtarget="Bill" class='c9' target="_blank" value="<?php echo $val; ?>">Show Bill</button></p>
